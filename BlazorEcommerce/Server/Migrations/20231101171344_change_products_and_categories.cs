...
{
    /// <inheritdoc />
    public partial class change_products_and_categories : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 8,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 3, "Diablo II is an action role-playing hack-and-slash computer video game developed by Blizzard North and published by Blizzard Entertainment in 2000 for Microsoft Windows, Classic Mac OS, and macOS.", "https://upload.wikimedia.org/wikipedia/en/d/d5/Diablo_II_Coverart.png", 0m, "Diablo II" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 3, "Day of the Tentacle, also known as Maniac Mansion II: Day of the Tentacle, is a 1993 graphic adventure game developed and published by LucasArts. It is the sequel to the 1987 game Maniac Mansion.", "https://upload.wikimedia.org/wikipedia/en/7/79/Day_of_the_Tentacle_artwork.jpg", 0m, "Day of the Tentacle" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Name", "Url" },
                values: new object[] { "Jackets", "Jackets" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 2, "Striped Logo-Intarsia Cotton Track Jacket", "https://www.mrporter.com/variants/images/30629810019746309/in/w560_q60.jpg", 9.99m, "GUCCI" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 2, "Webbing-Trimmed Logo-Print Stretch-Jersey Hooded Jacket", "https://www.mrporter.com/variants/images/1647597301034878/in/w560_q60.jpg", 7.99m, "GUCCI" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 2, "Monogrammed Linen-Blend Suit Jacket", "https://www.mrporter.com/variants/images/1647597311499279/in/w560_q60.jpg", 8.99m, "GUCCI" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 1, "Classic Blue Jeans", "https://denim.ua/image/cache/catalog/files/378194546_muzhskie-dzhinsy-levis-600x800.jpg", 49.99m, "Levi's Jeans" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 3, "Comfortable Running Shoes", "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/f655b4fb-35e9-4a63-acf8-c02dfd78cfda/zoom-fly-5-road-running-shoes-lkx7Zp.png", 89.99m, "Nike Running Shoes" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 4, "Casual Cotton T-Shirt", "https://brand-centr.com/image/cache/catalog/2031121%20-1-1678366701-1500x1500.jpg", 19.99m, "Adidas T-Shirt" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 5, "Elegant Red Evening Dress", "https://media.istockphoto.com/id/1217970889/photo/beautiful-female-red-dress-without-sleeves-isolated-on-white-evening-dress.jpg?s=612x612&w=0&k=20&c=SV4eWKwIY-HsUkrCi6X2jApUBcC5-lKFSd_tKG5Ewcw=", 129.99m, "Red Dress" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 8,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 6, "Classic Fedora Hat", "https://m.media-amazon.com/images/I/71EzZPIe+oL._AC_UY1000_.jpg", 39.99m, "Fedora Hat" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 9,
                columns: new[] { "CategoryId", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { 7, "Stylish Sunglasses", "https://assets.oakley.com/is/image/OakleyEYE/888392327031_holbrook_matte-black-prizm-sapphr-irid-polar_main_046.png?impolicy=SEO_4x3", 29.99m, "Sunglasses" });
        }
    }
}
